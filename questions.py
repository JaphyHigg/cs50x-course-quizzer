...
[{"question" : "[C] -  What is the convention for signaling that a number is in hexadecimal?",
  "answer" : "Prepend the number with 0x. For example: 0x500000FA4"}],
...
[{"question" : "[C] - What does 'free()' do and when do you use it?",
  "answer" : "It 'frees up' or 'gives back' or de-allocates any memory that was reserved/allocated by 'malloc', 'calloc' or 'realloc'. You need to pass to it what variable you are freeing, as an argument. For example: free(p)."}],
